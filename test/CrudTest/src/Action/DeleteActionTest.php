...
class DeleteActionTest extends TestCase
{
    ...
    public function testGetReturnsHtmlResponse()
    {
        ...
        $response = $this->deleteAction->__invoke($this->request, $this->response, $this->callable);
    ...
    protected function assertFormDecorated()
    {
        ...
        self::assertSame("$this->routePrefix/$id/delete", $this->form->getAttribute('action'));
    }
